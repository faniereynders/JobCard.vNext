...
namespace JobCard.Application.UI
{
    ...
    public partial class Main : Form
    {
        ...
        {
            this.OpenOrganization(e.NewValue);
        }
        ...
        private void Main_Load(object sender, EventArgs e)
        {
            ...
            this.frmConnection.CompanyNameChanged += new frmConnection.CompanyNameChangedEventHandler(this.CompanyNameChanged);
            //TODO: cmd args
            ...
            //{
            //    this.OpenOrganization(System.Windows.Forms.Application.StartupPath + "\\" + this.DatabaseName + ".jcc");
            //    if (this.SignIn)
            //        return;
            //    this.SignOut();
            //}
